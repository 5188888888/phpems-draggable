    ...
    {x2;endif}
                <div class="box itembox" style="margin-bottom:0px;border-bottom:1px solid #CCCCCC;">
                    <div class="col-xs-12">
                        <ol class="breadcrumb">
                            ...
                            <li><a href="index.php?course-master-course-members&courseid={x2;$course['csid']}">成员管理</a></li>
                ...
                <div class="box itembox" style="padding-top:10px;margin-bottom:0px;">
                    <h4 class="title" style="padding:10px;">
                        选择成员
                        <a class="btn btn-primary pull-right" href="index.php?{x2;$_app}-master-course-members&courseid={x2;$course['csid']}">人员列表</a>
                    </h4>
                    <form action="index.php?course-master-course-selectmember&courseid={x2;$course['csid']}" method="post" style="margin-top:10px;" class="form-inline">
                        <table class="table">
                            <tr>
                    ...
                    <form action="index.php?course-master-course-selectmember" method="post">
