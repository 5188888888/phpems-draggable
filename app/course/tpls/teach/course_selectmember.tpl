...
<div class="container-fluid">
    ...
    {x2;endif}
                <div class="box itembox" style="margin-bottom:0px;border-bottom:1px solid #CCCCCC;">
                    <div class="col-xs-12">
                        <ol class="breadcrumb">
                            <li><a href="index.php?course-teach-course">{x2;$apps[$_app]['appname']}</a></li>
                            <li><a href="index.php?course-teach-course-members&courseid={x2;$course['csid']}">课程管理</a></li>
                ...
                <div class="box itembox" style="padding-top:10px;margin-bottom:0px;">
                    <h4 class="title" style="padding:10px;">
                        选择成员
                        <a class="btn btn-primary pull-right" href="index.php?{x2;$_app}-teach-course-members&courseid={x2;$course['csid']}">人员列表</a>
                    </h4>
                    <form action="index.php?course-teach-course-selectmember&courseid={x2;$course['csid']}" method="post" style="margin-top:10px;" class="form-inline">
                        <table class="table">
                            <tr>
                    ...
                    <form action="index.php?course-teach-course-selectmember" method="post">
