                                    ...
                                    <div class="qq-uploader-selector" style="width:30%" style="clear:both;">
                                        <div class="qq-upload-button-selector" style="clear:both;">
                                            ...
                                            <ul class="qq-upload-list-selector list-unstyled" aria-live="polite" aria-relevant="additions removals" style="clear:both;">
                                                <li class="text-center">
                                                    <div class="thumbnail">
                                                        <img class="qq-thumbnail-selector" src="files/public/img/noimage.gif" alt="Upload the Pictures">
                                                        <input type="hidden" class="qq-edit-filename-selector" name="args[coursethumb]" tabindex="0" value="files/public/img/noimage.gif">
                                                    </div>
                                                </li>
                                            </ul>
                                        </div>
