                        ...
                        <ul class="list-unstyled list-img">
                            ...
                            <li class="border morepadding">
                                <div class="desc">
                                    ...
                                    <input type="hidden" id="draggableQuestion{x2;v:question['questionid']}" name="question[{x2;v:question['questionid']}]" value="{x2;$sessionvars['examsessionuseranswer'][v:question['questionid']]}" rel="{x2;v:question['questionid']}" />
                                    <!--生成拖放题区域-[END]-->
                                </div>
                            </li>
                            {x2;else}
