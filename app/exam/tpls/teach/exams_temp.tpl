...
{x2;endif}
                ...
                <div class="box itembox" style="padding-top:10px;margin-bottom:0px;">
                    ...
                    <form action="index.php?exam-teach-exams-temppage" method="post" class="form-horizontal">
                        ...
                        <div class="form-group">
                            <label class="control-label col-sm-2">考试逻辑主线：</label>
                              <div class="col-sm-4">
                                  <select class="combox form-control" autocomplete="off" id="selectedsubjectid" msg="请选择逻辑主线" needle="needle" min="1" name="args[examsubject]" onchange="javascript:loadsubjectsetting(this);">
