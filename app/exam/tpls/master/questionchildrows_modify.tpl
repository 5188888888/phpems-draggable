                    ...
                    <form action="index.php?exam-master-rowsquestions-modifychildquestion" method="post" class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                <div id="answerbox_7" class="answerbox"{x2;if:$questypes[$question['questiontype']]['questchoice'] != 7 || $questypes[$question['questiontype']]['questsort']} style="display:none;"{x2;endif}>
