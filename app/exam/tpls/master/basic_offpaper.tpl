                    ...
                    <table class="table table-hover table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a class="btn confirm" msg="确定要强行收卷？" href="index.php?exam-master-basic-savepaper&token={x2;v:user['examsessiontoken']}&examsessionid={x2;v:user['examsessionid']}" title="强行收卷"><em class="glyphicon glyphicon-remove"></em></a>
                                    </div>
                                </td>
                            </tr>
                            {x2;endtree}
