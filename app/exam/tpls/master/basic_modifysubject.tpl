...
{x2;endif}
                <div class="box itembox" style="margin-bottom:0px;border-bottom:1px solid #CCCCCC;">
                    <div class="col-xs-12">
                        <ol class="breadcrumb">
                            ...
                            <li><a href="index.php?{x2;$_app}-master-basic-subject">逻辑主线管理</a></li>
                            <li class="active">修改逻辑主线</li>
                        </ol>
                    </div>
                </div>
                <div class="box itembox" style="padding-top:10px;margin-bottom:0px;">
                    <h4 class="title" style="padding:10px;">
                        修改逻辑主线
                        <a class="btn btn-primary pull-right" href="index.php?exam-master-basic-subject">逻辑主线管理</a>
                    </h4>
                    <form action="index.php?exam-master-basic-modifysubject" method="post" class="form-horizontal">
                        <fieldset>
                            <div class="form-group">
                                <label for="subject" class="control-label col-sm-2">逻辑主线名称：</label>
                                <div class="col-sm-9">
                                    <input class="form-control" name="args[subject]" id="subject" type="text" size="30" value="{x2;$subject['subject']}" needle="needle" msg="您必须输入一个逻辑主线名称" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="subject" class="control-label col-sm-2">逻辑主线题型：</label>
                                <div class="col-sm-9">
