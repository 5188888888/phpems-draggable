                                    ...
                                    <div class="qq-uploader-selector" style="width:30%" qq-drop-area-text="可将图片拖拽至此处上传" style="clear:both;">
                                        <div class="qq-upload-button-selector" style="clear:both;">
                                            ...
                                            <ul class="qq-upload-list-selector list-unstyled" aria-live="polite" aria-relevant="additions removals" style="clear:both;">
                                                <li class="text-center">
                                                    <div class="thumbnail">
                                                        <img class="qq-thumbnail-selector" src="{x2;if:$seminar['seminarthumb']}{x2;$seminar['seminarthumb']}{x2;else}files/public/img/noimage.gif{x2;endif}" alt="点击上传新图片">
                                                        <input type="hidden" class="qq-edit-filename-selector" name="args[seminarthumb]" tabindex="0" value="{x2;if:$seminar['seminarthumb']}{x2;$seminar['seminarthumb']}{x2;else}files/public/img/noimage.gif{x2;endif}">
                                                    </div>
                                                </li>
                                            </ul>
                                        </div>
